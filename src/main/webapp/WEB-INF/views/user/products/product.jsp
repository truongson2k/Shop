...
<div class="well well-small">
	...
	<div class="row-fluid">
			...
			<c:forEach var="item" begin="1" end="${countlist}" items="${ productByIdCategory}" varStatus="loop">
			...
			<h3><span><fmt:formatNumber type="number"
												groupingUsed="true" value="${ item.price }" /> ₫</span></h3>
